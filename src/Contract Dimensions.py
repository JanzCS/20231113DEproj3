...
# domestic_or_foreign_entity.repartition(1).write.mode('overwrite').parquet(
#     domestic_or_foreign_entity_dim_location
# )
naics.repartition(1).write.mode('overwrite').parquet(naics_dim_location)
country_of_origin.repartition(1).write.mode('overwrite').parquet(country_of_origin_dim_location)
