...
county_pop_estimates_2010_through_2019 = spark.read.csv(external_data_location+"co-est2020-alldata.csv", header=True, inferSchema=True)
county_pop_estimates_2020_through_2022 = spark.read.csv(external_data_location+"co-est2022-alldata.csv", header=True, inferSchema=True)
...
county_pop_estimates_2010_through_2019 = county_pop_estimates_2010_through_2019.select("state", "county", 'popestimate2019')
county_pop_estimates_2020_through_2022 = county_pop_estimates_2020_through_2022.select("state", "county", 'popestimate2020', 'popestimate2021', 'popestimate2022')
...
county_gdp = spark.read.csv(external_data_location+"1976-2022-house.csv", header=True, inferSchema=True)
